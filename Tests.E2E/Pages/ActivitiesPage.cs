...
namespace Tests.E2E.Pages
{
    ...
    public class ActivitiesPage(IPage page)
    {
        ...
        {
            return page.Locator("[data-testid='activity-item']", new() { HasText = title });
        }

        public ILocator ViewButtonFor(string title)
        {
            return ItemWithTitle(title).Locator("[data-testid='view-button']");
        }

        public ILocator DeleteButtonFor(string title)
        {
            return ItemWithTitle(title).Locator("[data-testid='delete-button']");
        }
        ...
        {
            return await ActivityItems.CountAsync();
        }
